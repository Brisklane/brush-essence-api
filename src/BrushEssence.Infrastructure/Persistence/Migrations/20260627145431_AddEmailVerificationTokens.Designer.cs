...
namespace BrushEssence.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260627145431_AddEmailVerificationTokens")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BrushEssence.Domain.Entities.CustomRequest", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("custom_requests", (string)null);
                });

            modelBuilder.Entity("BrushEssence.Domain.Entities.CustomRequestImage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("custom_request_images", (string)null);
                });

            modelBuilder.Entity("BrushEssence.Domain.Entities.CustomRequestStatusEvent", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("BrushEssence.Domain.Entities.EmailVerificationToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("BrushEssence.Domain.Entities.Review", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("PaintingId", "Status");

                    b.HasIndex("PaintingId", "UserId")
                        .IsUnique();
            ...
            modelBuilder.Entity("BrushEssence.Domain.Entities.CustomRequestImage", b =>
                {
                    b.HasOne("BrushEssence.Domain.Entities.CustomRequest", "CustomRequest")
                        .WithMany("Images")
